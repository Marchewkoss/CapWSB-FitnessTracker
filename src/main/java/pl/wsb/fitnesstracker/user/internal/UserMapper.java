...
public class UserMapper {
    ...
    /**
     * Converts a {@link User} entity to a simplified {@link UserDto} with only ID, firstName, and lastName.
     * This is typically used for list views where full details aren't needed.
     *
     * @param user the user entity to convert
     * @return a simplified user DTO containing only basic identification fields
     */
